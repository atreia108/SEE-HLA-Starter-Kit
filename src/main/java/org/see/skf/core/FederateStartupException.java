 ...
 * @since 2.1
 */
public final class FederateStartupException extends Exception {

    FederateStartupException(String message, Throwable cause) {
        super(message, cause);
    }

    FederateStartupException(Throwable cause) {
        super(cause);
    }
}
